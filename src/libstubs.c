...
/* GCC 10.5 parses all branches of __builtin_choose_expr, so
   void-returning AROS_LC* macros hit 'void __ret' declaration error.
   Redirect to the NR (No Return) variant which skips __AROS_LC_RET. */
#undef ERR_print_errors
#define ERR_print_errors(___bp) \
    AROS_LC1NR(void, ERR_print_errors, \
