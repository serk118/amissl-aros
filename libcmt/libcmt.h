...
#ifdef __AROS__
/* AROS defines socket(), bind(), etc. as function-like macros
   in <defines/bsdsocket.h> which conflict with the declarations below. */
/* AROS also provides bcopy/bzero/bcmp/index/rindex as static inlines
   in <aros/stdc/_strings.h>. We suppress them with _STDC_NOINLINE_DEPRECATED
   to avoid redefinition in string_bcopy.c/string_bzero.c, so declare them here. */
#ifndef _STDC_NOINLINE_DEPRECATED
#define _STDC_NOINLINE_DEPRECATED
#endif
...
#if !defined(__amigaos4__) && !defined(__AROS__) && !defined(__CLIB2__)
